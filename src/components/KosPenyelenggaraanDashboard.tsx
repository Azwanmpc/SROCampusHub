    ...
    <div>
      ...
      <div className="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div className="border-l-4 border-[#1e3a5f] bg-white p-4 shadow-sm">
          ...
          <div className="mt-1.5 text-[12px] font-semibold text-[rgba(32,30,29,0.55)]">Jumlah kos: {fmtRM(jumlahKosTahunDipilih)}</div>
        </div>
      </div>
      ...
      <div className="mb-5 border border-[rgba(32,30,29,0.2)] bg-white p-[18px]">
        ...
        <div className="mb-3 text-xs text-[rgba(32,30,29,0.55)]">Jumlah kos (RM) mengikut bulan bagi tahun {yearSel}</div>
      ...
      <div className="mb-5 grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="border border-[rgba(32,30,29,0.2)] bg-white p-[18px]">
          ...
          <div className="mb-3 text-xs text-[rgba(32,30,29,0.55)]">Agregat kos mengikut lokasi bagi tahun {yearSel}</div>
        ...
        <div className="border border-[rgba(32,30,29,0.2)] bg-white p-[18px]">
          ...
          <div className="mb-3 text-xs text-[rgba(32,30,29,0.55)]">Agregat kos mengikut kategori kerja bagi tahun {yearSel}</div>
          <div className="relative h-[300px]">
      ...
      <div className="border border-[rgba(32,30,29,0.2)] bg-white p-[18px]">
        ...
        <div className="mb-3 text-xs text-[rgba(32,30,29,0.55)]">Senarai penuh rekod bagi tahun dipilih</div>
