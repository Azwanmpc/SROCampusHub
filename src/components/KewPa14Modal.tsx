      ...
      <div className="print-area relative max-h-[94vh] w-full max-w-[720px] overflow-y-auto bg-[#e7e5e5] shadow-[0_12px_32px_rgba(45,43,43,0.22)]">
        ...
        <div className="print-page-break bg-white p-4 font-archivo text-[#1a1a1a] sm:p-8">
          ...
          <div className="mb-4 flex gap-2 text-[11.5px] sm:mb-6 sm:text-[13px]">
            ...
            <span className="flex-1 border-b border-[#1a1a1a] pb-0.5">{scopeLabel}</span>
          </div>

          <div className="overflow-x-auto">
            <table className="w-full min-w-[520px] border-collapse text-[10px] sm:min-w-0 sm:text-[11.5px]">
              <thead>
                <tr className="bg-[#d9d9d9]">
                  <th className="w-[7%] border border-[#1a1a1a] px-1.5 py-1.5 sm:px-2">BIL</th>
                  <th className="w-[35%] border border-[#1a1a1a] px-1.5 py-1.5 sm:px-2">NAMA ASET</th>
                  <th className="w-[26%] border border-[#1a1a1a] px-1.5 py-1.5 sm:px-2">NO. PENDAFTARAN</th>
                  <th className="w-[22%] border border-[#1a1a1a] px-1.5 py-1.5 sm:px-2">LOKASI</th>
                  <th className="w-[10%] border border-[#1a1a1a] px-1.5 py-1.5 sm:px-2">CATATAN</th>
                </tr>
              </thead>
              <tbody>
                {items.length === 0 ? (
                  ...
                  items.map((item, i) => (
                    <tr key={item.id}>
                      ...
                      <td className="border border-[#1a1a1a] px-1.5 py-1 sm:px-2">{item.lokasi}</td>
                      <td className="border border-[#1a1a1a] px-1.5 py-1 text-center sm:px-2">Rosak</td>
                    </tr>
                  ))
                )}
              </tbody>
        ...
        <div className="flex flex-col gap-2 bg-[#e7e5e5] p-3 print:hidden sm:flex-row sm:p-4">
          ...
          <button
            onClick={() => generateKewPa14(items, scopeLabel)}
