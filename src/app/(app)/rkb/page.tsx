...
export default function RkbPage() {
  return (
    <div>
      <div className="mb-0.5 font-archivo text-[26px] font-extrabold">Dashboard RKB</div>
      <div className="mb-3.5 text-[13.5px] text-[rgba(32,30,29,0.6)]">
        Reformasi Kerenah Birokrasi: kes, penambahbaikan, impak
      </div>
      ...
      <div className="flex flex-col items-center justify-center gap-3 border border-[rgba(32,30,29,0.4)] bg-white px-6 py-16 text-center">
        <ChartLine weight="duotone" size={40} className="text-[rgba(32,30,29,0.35)]" />
        ...
        <div className="max-w-[380px] text-sm text-[rgba(32,30,29,0.6)]">
          Modul Dashboard RKB sedang dalam pembangunan dan akan tersedia tidak lama lagi.
        </div>
      </div>
    </div>
  );
